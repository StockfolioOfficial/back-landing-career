...
from recruits.views     import RecruitListView, RecruitView, RecruitAdminView, AdmipageDashboardView, AdminRecruitListView, AdminPageRecruitView, RecruitListAdminView

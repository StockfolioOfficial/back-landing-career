...
from applications.views import ApplicationAdminView, ApplicationAdminDetailView,CommentAdminView,CommentAdminModifyView, RecruitApplicatorView, ApplicatorAdminView 
